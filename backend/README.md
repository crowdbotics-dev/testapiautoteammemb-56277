...
## Project Structure
    ...
    ├── testapiautoteammemb_56277  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_56277`
...
2. Clone this repo and `cd testapiautoteammemb_56277`
